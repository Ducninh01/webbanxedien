<header class="header-one header-two">
                ...
                <div class="col-sm-12">
                    <div class="middel-top">
                        <div class="left floatleft">
                            <p><i class="mdi mdi-clock"></i> T2 - CN : 08:00-16:45</p>
                        </div>
                    </div>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-2">
                <div class="logo">
                    <a href="?act=home"><img src=https://th.bing.com/th/id/OIP.5R4ALduVWUHKggD0vAgGCgAAAA?pid=ImgDet&rs=1 alt="Anbicoshop" /></a>
                </div>
            </div>
            <div class="col-sm-8">
    ...
    <script src="Views\cart\file.js"></script>
</header>