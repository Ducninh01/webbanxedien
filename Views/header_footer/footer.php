                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>Số 296 đường Trần Thái Tông, Thành phố Thái Bình, Việt Nam.</p>
                                    </li>
                                    <li>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 r-margin-top wide-mobile">
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                    <li><a href="https://www.facebook.com/xedienanbico"><img src="public/img/footer/facebook-sociocon.png" alt="facebook" /></a></li>
                                    <li><a href="https://www.tiktok.com/@xedienanbico"><img src="public/img/footer/OIP.Jfif" alt="Tiktok" /></a></li>
                                    <li><a href="https://www.youtube.com/@anbicoebike"><img src="public/img/footer/tải xuống.Jfif" alt="Youtobe" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; Anbico 2023. Bản quyền Anbico.</p>
                </div>
